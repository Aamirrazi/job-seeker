...
public class JobSpecification {
    ...
    /**
     * Creates a specification to find jobs where the job's minSalary is less than or equal to the desired maxSalary.
     * This is part of the salary range overlap logic.
     */
    ...
    /**
     * Creates a specification to find jobs where the job's maxSalary is greater than or equal to the desired minSalary.
     * This is part of the salary range overlap logic.
     */
